...
= Version 1.1.0 – Aug 27, 2026 =

+	Compatible with WordPress 7.1.
+	Added `2587` to port options.
+	Added rate limit options (n sends per n minutes).
+	Added log emails option to log email sends to system log.
+	Admin page layout enhancements.

= Version 1.0.15 – May 23, 2026 =
